...
# Generates a machine code for the SQL connection names, so multiple clients can run at the same time.
def machineCode():
    global machine_code
    machine_code = random.randint(000000, 999999)
    print("System code: #" + str(machine_code))
